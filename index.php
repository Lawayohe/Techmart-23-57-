    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            <div class="email">
              Email:
              <a href="mailto:TechMart.support@yourwebsite.com" class="email__addr">TechMart.support@yourwebsite.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> TechMart&trade;
          </div>

          <div class="developer">
            Developed by TechMart
          </div>
